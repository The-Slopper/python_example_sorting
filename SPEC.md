# Especificacao Tecnica — Sorting

| Campo | Valor |
|---|---|
| Repositorio | `python_example_sorting` |
...
Implementacao de referencia de algoritmos de ordenacao com analise de complexidade. Este documento descreve requisitos, arquitetura e criterios de aceite.
